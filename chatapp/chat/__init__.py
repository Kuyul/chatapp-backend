...
from chatapp.chat.controller.chat import SendChatController, GetChatSessionsController, GetMessagesController
...
chat_api.add_resource(GetMessagesController, "/messages")
